...
class ChoiceReaction(BaseTask):
  ...
  def _update(self, model, data):
    ...
    self._info['time_step'] = self._trial_idx
    # Set defaults
    terminated = False
    truncated = False
    ...
    if 50 > force > 25:
      ...
      self._info["steps_since_last_hit"] = self._steps_since_last_hit
  ...
  def _reset(self, model, data):
    ...
    self._info = {"target_hit": False, "new_button_generated": False, "terminated": False, "truncated": False,
                  "termination": False, "dist_from_target": 0, "acc_dist": 0, "end_time": end_time}
